...
@section('content')
    ...
    <div class="container my-4 p-4 bg-white rounded shadow-sm">
        ...
        <div class="row pb-3 mb-3 align-items-center">
            <!-- ユーザーアイコン -->
            <div class="col-auto">
                <!-- <img src="{{ asset($user->image ?? 'default_icon.png') }}"
                     alt="ユーザーアイコン" 
                     class="rounded-circle" 
                     style="width: 50px; height: 50px; object-fit: cover;"> -->
        <img src="{{  asset($article->user->image?? 'default_icon.png') }}" alt="ユーザーアイコン" style="width: 100px; height: 100px; border-radius: 50%; margin-right: 10px; object-fit: cover;">
