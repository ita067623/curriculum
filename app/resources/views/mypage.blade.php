...
<div class="container mt-4">
    <div class="header p-3 ">
        ...
        <div class="user-info d-flex align-items-center mb-3 pb-3 border-bottom">
            <img src="{{ asset($user->icon_path ?? 'default_icon.png') }}" alt="ユーザーアイコン" style="width: 50px; height: 50px; border-radius: 50%; margin-right: 10px;">
            <span class="h5">{{ $user->name ?? 'ゲスト' }}</span>
        </div>

        <!-- ナビゲーションリンク -->
        <div class="navigation mb-3">
        <div class="nav-link mb-2 border-bottom p-2" style="font-size: 1.1rem; cursor: pointer;" onclick="location.href='{{ route('articles.create', $article->id) }}'">
        ...
        <div class="user-actions d-flex flex-column align-items-start ">
            ...
            <div class="nav-link border-bottom p-2" style="font-size: 1.1rem; cursor: pointer; display: block; width: 100%;"" onclick="if(confirm('本当に退会しますか？')) location.href='{{ url('withdraw') }}';">
